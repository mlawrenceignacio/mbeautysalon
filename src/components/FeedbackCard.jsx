  ...
  return (
    <div className="bg-pink-100 rounded-lg border border-black p-2 md:w-[80%] lg:w-[70%]">
      ...
      <div className="flex justify-between items-center relative">
        ...
        {showMenu && (
          <div className="absolute top-5 right-1 text-sm z-100 flex flex-col bg-white text-red-950 p-2 rounded-md gap-1">
            <button
              className="hover:bg-red-950 hover:text-white rounded-sm"
              onClick={() => {
                setShowMenu(false);
                onEdit(fb);
              }}
            ...
            <button
              className="hover:bg-red-950 hover:text-white rounded-sm px-2"
